...
def run_legal_war_room(user_message, retrieved_laws):
    ...
    researcher = Agent(
        ...
        backstory='You are a meticulous paralegal. You never make up laws. You strictly rely on the provided database (e.g., DGCA, MoRTH, RBI, or CPA 2019).',
        verbose=True,
    ...
    legal_crew = Crew(
        ...
        process=Process.sequential # This forces them to work in order: 1 -> 2 -> 3
    )
